...
import { HubCardsSkeleton } from "@/components/github/github-skeletons";
...
export default function GithubSettingsPage() {
  return (
    <div className="space-y-6">
      ...
      <Suspense fallback={<HubCardsSkeleton />}>
        <HubCards />
      </Suspense>
    </div>
  );
        ...
        <Card size="sm">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-sm">
              {declineNumeric(contributorCount, "element", true)} do przejrzenia
            </p>
          </CardContent>
        </Card>
      </Link>
      <Link href="/settings/github/repositories" className="block">
        <Card size="sm">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-sm">
              {declineNumeric(unlinkedCount, "repozytorium", true)} bez projektu
            </p>
          </CardContent>
        </Card>
      </Link>
      <Link href="/settings/github/project-repos" className="block">
        <Card size="sm">
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-sm">
              {declineNumeric(reposWithoutTeamCount, "repozytorium", true)} bez
              zespołu
            </p>
          </CardContent>
        </Card>
